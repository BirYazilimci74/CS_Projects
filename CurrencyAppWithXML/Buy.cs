...
namespace CurrencyAppWithXML
{
    public class Buy
    {
        ...
        public void MakeBuy(string customerName, int currencyID, string operationType, decimal currentCurrencyValue, decimal amount)
        {
            ...
            Console.WriteLine("Buying Successfully Done!!");
        }
    }
}
